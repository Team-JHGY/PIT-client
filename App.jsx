...
function BottomNav() {
  return (
    <Tab.Navigator style={styles.bottomNavMain}
      screenOptions={({ route }) => ({
      ...
      <Tab.Screen name={userAuth === "User"? "홈":"스케쥴"} component={userAuth === "User"? MainView :Schedule} /> 
      <Tab.Screen name={userAuth === "User"? "운동/식단":"회원"} component={userAuth === "User"? NewMembers :Members} />
      <Tab.Screen name={userAuth === "User"? "마이":"마이"} component={userAuth === "User"? MyPage :MyPage} />
    </Tab.Navigator>
  );
}
