...
// custom
import {getDayOfWeek} from '../../../src/utils/commonFunctions'
    ...
    if(DayComponent) {
      ...
      day = (
        ...
        >
          ...
          >
            <View style={[dayContainerStyle, _dateViewStyle, {marginLeft: 5, marginRight: 5, width: '70%', height: '100%', borderRadius: 10}]}>
              {showDayName && (
                <Text
                  style={[{fontSize: dateNameFontSize, marginTop: 5}, _dateNameStyle]}
