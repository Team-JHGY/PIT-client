...
class CalendarStrip extends Component {
  ...
  static defaultProps = {
    ...
    showDate: true,
    updateWeek: true,
    iconLeft: require("../../../assets/img/Schedule/left-arrow-black.png"),
    iconRight: require("../../../assets/img/Schedule/right-arrow-black.png"),
  ...
  updateMonthYear = (weekStartDate, weekEndDate) => {
    ...
    this.props.setFirstDayOfWeek(weekStartDate)
    this.props.setLastDayOfWeek(weekEndDate)
  }
        ...
        <View style={[this.props.innerStyle, {height: this.state.height}]}>
          ...
          <View style={styles.datesStrip}>
            ...
            <View onLayout={this.onLayout} style={styles.calendarDates}>
              ...
              {this.props.showDate === true && this.renderWeekView(this.state.days)}
            </View>
