...
import { StyleSheet, Text, View, SafeAreaView, Pressable,Image, TextInput, Modal } from 'react-native'
       ...
       <Appbar.Header style={globalStyle.titleAppbar}>
        ...
        <SafeAreaView style={styles.mainForm}>
            <View style={styles.viewPadding}>
                    ...
                    <View style={modalstyles.centeredView}>
                        <View style={modalstyles.modalView}>
                            ...
                            <View style={modalstyles.UserInfo}>
                                ...
                                <Image source={{uri:'https://img.sbs.co.kr/newsnet/etv/upload/2021/04/23/30000684130_500.jpg'}} style={modalstyles.UserImg}/>

                                
                                <Text style={globalStyle.heading2}>김태리</Text>
                                <Text style={globalStyle.body2}>(여, ??세)</Text>
                                <Text style={[globalStyle.body2, modalstyles.infoText]}>추가하려는 회원님이 맞는지 확인해주세요.</Text>
                                ...
                                <View style={modalstyles.row}>
                                    ...
                                    >
                                        ...
                                        <Text style={[globalStyle.textDarkRed,globalStyle.button, modalstyles.btnText]}>취소</Text>
                                    </Pressable>
                ...
                <Text style={styles.infoText}>추가하려는 회원님의 앱에서 마이 &gt; 회원코드에서 회원코드를 확인할 수 있습니다.</Text>
